...
echo "/lib/modules/$(uname -r)/kernel/drivers/char/bc_example.ko: /lib/modules/$(uname -r)/kernel/drivers/char/pvrsrvkm.ko" >>/tmp/modules.$$.tmp
	...
	install_file libpvrPVR2D_X11WSEGL.so /usr/lib/libpvrPVR2D_X11WSEGL.so.1.1.16.4117 "shared library" 0644 0:0
	install_link libpvrPVR2D_X11WSEGL.so.1.1.16.4117 /usr/lib/libpvrPVR2D_X11WSEGL.so
	install_file libpvrEWS_WSEGL.so /usr/lib/libpvrEWS_WSEGL.so.1.1.16.4117 "shared library" 0644 0:0
	install_link libpvrEWS_WSEGL.so.1.1.16.4117 /usr/lib/libpvrEWS_WSEGL.so
	...
	install_file libews.so /usr/lib/libews.so.1.1.16.4117 "shared library" 0644 0:0
	install_link libews.so.1.1.16.4117 /usr/lib/libews.so
